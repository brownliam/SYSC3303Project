...
public class TFTPReadRequestPacket extends TFTPPacket {
	...
	public byte[] getOpcode(){
		return new byte[]{0, TFTPDefines.RRQ};
	}
	...
	public TFTPReadRequestPacket(String filename, String mode, InetAddress address, int port)  throws Exception
	{
		super(address, port);
	...
	public TFTPReadRequestPacket(byte[] data, int length){
		super(data, length);
	}
